...
ULTIMATE GOAL: We want to achieve a fully functional Chrome extension that converts any web article to natural-sounding audio with one click, featuring a floating player, MP3 download, and usage-limited free tier (10 articles/month). Consider missing elements and plan accordingly. If an element is missing, search first to confirm it doesn't exist, then if needed author the specification at specs/FILENAME.md. If you create a new element then document the plan to implement it in @IMPLEMENTATION_PLAN.md using a subagent.
